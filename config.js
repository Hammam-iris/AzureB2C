...
exports.creds = {
  ...
  // feature.
  identityMetadata: 'https://login.microsoftonline.com/irisadvB2C.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
  // or equivalently: 'https://login.microsoftonline.com/<tenant_guid>/v2.0/.well-known/openid-configuration'

  // Required, the client ID of your app in AAD  
  clientID: 'dccc462b-0fbe-498d-9a6b-6cbe9bf62b35',
  ...
  redirectUrl: 'https://activedirb2c.azurewebsites.net/auth/openid/return', 
  ...
  clientSecret: ',PL13;Xzt5}]>a4rX.yFQP4;', 
...
// replace irisadvB2C.onmicrosoft.com with your tenant name, and
// replace <signin_policy_name> with your signin policy name.
exports.destroySessionUrl = 
  'https://login.microsoftonline.com/irisadvB2C.onmicrosoft.com/oauth2/v2.0/logout' +
  '?p=B2C_1_signin' +
  '&post_logout_redirect_uri=https://activedirb2c.azurewebsites.net/';
...
exports.databaseUri = 'mongodb://M_Hammam:01229367833Mh*@ds042527.mlab.com:42527/m_hammam';
